...
function Game() {
    ...
    const itemsScoreLimit = [{id: 1,value: "3",} , {id: 2,value: "7",} , {id: 3,value: "10"}];
    const itemsBallSpeed = [{id: 1,value: "Normal"} , {id: 2,value: "Low"} , {id: 3,value: "Fast"}];
    const itemsFieldColor = [{id: 1,value: "Black"} , {id: 2,value: "White"} , {id: 3,value: "Green"} , {id: 4,value: "Blue"} , {id: 5,value: "Red"}];
    const itemsBallColor = [{id: 1,value: "White"} , {id: 2,value: "Black"} , {id: 3,value: "Green"} , {id: 4,value: "Blue"} , {id: 5,value: "Red"}];
    const itemsYourColor = [{id: 1,value: "White"} , {id: 2,value: "Black"} , {id: 3,value: "Green"} , {id: 4,value: "Blue"} , {id: 5,value: "Red"}];
    const itemsOpponentcolor = [{id: 1,value: "White"} , {id: 2,value: "Black"} , {id: 3,value: "Green"} , {id: 4,value: "Blue"} , {id: 5,value: "Red"}];
    const itemsOpponent = [{id: 1,value: "Random"} , {id: 2,value: "Ramzi"} , {id: 3,value: "Sommecaise"}];
    const itemsPartyType = [{id: 1,value: "Join"} , {id: 2,value: "Create"}];
    const itemsPartyType2 = [{id: 1,value: "Default",} , {id: 2,value: "Customized"}];
    ...
    return (
        ...
        <div className={clsx(classes.Game, ftShowGame(user))}>
            ...
            <div className={clsx(classes.playOrWatch, ftShowGameVue("choosePlayOrWatch"))}>
                <button className={clsx(classes.configButton, classes.butttonGame)} onClick={()=>setActiveGameVue("chooseGameType")}>Play a game</button>
                <button className={clsx(classes.configButton, classes.butttonGame)}>Watch other users play</button>
            </div>

            <div className={clsx(classes.chooseGameType, ftShowGameVue("chooseGameType"))}>
                <button className={clsx(classes.configButton, classes.butttonGame)} onClick={()=>setActiveGameVue("chooseCustomization")}>Room</button>
                <button className={clsx(classes.configButton, classes.butttonGame)}>Current game invites</button>
            </div>

            <div className={clsx(classes.chooseCustomization, ftShowGameVue("chooseCustomization"))}>
                <div className={clsx(classes.customizationSection, classes.customizationSectionTop)}>
                ...
                <div className={clsx(classes.customizationSection, classes.customizationSectionMiddle)}>
                ...
                <div className={clsx(classes.customizationSection, classes.customizationSectionBottom)}>
                ...
                <button className={clsx(classes.configButton, classes.playButton)} onClick={()=>setActiveGameVue("pong")}>PLAY</button>
            </div>
