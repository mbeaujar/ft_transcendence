  ...
  return (
    <div className={classes.Theme}>
      ...
      <div className={classes.ThemeBottom}>
        <div
          className={clsx(classes.Buttontheme, classes.DarkTheme,activeTheme('dark'))}
          onClick={()=>props.setTheme('dark')}
        ></div>
        <div
          className={clsx(classes.Buttontheme, classes.LightTheme,activeTheme('light'))}
          onClick={()=>props.setTheme('light')}
        ></div>
        <div
          className={clsx(classes.Buttontheme, classes.BlueTheme,activeTheme('blue'))}
